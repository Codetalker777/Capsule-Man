...
public class Generatelv2 : MonoBehaviour {
				...
				while (count2 < 5) {
					...
					if (chance2 < 0.45) {
						...
						/*if (chance3 < 0.2) {
							...
							count2 = count2 + 1;
						} else if (chance3 >= 0.25 && chance3 < 0.5) {
							...
							count2 = count2 + 1;
						} else if (chance3 >= 0.5 && chance3 < 0.75) {
						...
						} else if (chance4 >= 0.25 && chance4 < 0.5) {
						...
						} else if (chance4 >= 0.5 && chance4 < 0.75) {
